...
ent-WindoorSalvageScienceLocked = { ent-Windoor }
    .desc = { ent-Windoor.desc }
    .suffix = Утильсикй/Научный, Закрыт
ent-PlasmaWindoorSalvageScienceLocked = { ent-WindoorPlasma }
    .desc = { ent-WindoorPlasma.desc }
    .suffix = Утильский/Научный, Закрыт, Плазма