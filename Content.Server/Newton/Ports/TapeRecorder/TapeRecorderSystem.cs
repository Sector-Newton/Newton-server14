...
using Content.Shared.Newton.Ports.TapeRecorder;
using Content.Shared.Newton.Ports.TapeRecorder.Components;
using Content.Shared.Newton.Ports.TapeRecorder.Events;
using Robust.Shared.Prototypes;
using System.Text;
using Content.Shared.Corvax.TTS;

namespace Content.Server.Newton.Ports.TapeRecorder;
