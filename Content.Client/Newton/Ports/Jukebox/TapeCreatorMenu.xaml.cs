...
public sealed partial class TapeCreatorMenu : DefaultWindow
{
    ...
    private void OnUploadButtonPressed(BaseButton.ButtonEventArgs obj)
    {
        ...
        _popupSystem.PopupEntity("Чтение диска. Пожалуйста, подождите...", _entity.Owner);
    }
    ...
    private async void TryLoadSong(BaseButton.ButtonEventArgs obj)
    {
        ...
        {
            _popupSystem.PopupEntity($"Превышение частоты трека на {_currentFileSize - _maxFileSize} наночастиц", _entity.Owner);
            return;
        }
